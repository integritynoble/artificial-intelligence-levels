...
| DK-03 | Convert to TMLR format without automatic cuts | `assigned` | not yet written | Unblocked: source builds; TMLR template builds locally. Re-anchor table numbers (+1) before applying proposals |
