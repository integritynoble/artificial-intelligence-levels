...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Unified Intelligence Theory and the Artificial Intelligence Level}
...
\begin{document}
\begin{center}
{\LARGE\bfseries Unified Intelligence Theory and the Artificial Intelligence Level:}\\[6pt]
...
and the AI-Level Score of a Base Model Across a Standardized Harness Ladder}\\[16pt]
...
\[
z_{U,n}(A) = \prod_{X \in \{C, I, O, SA\}} \mathbb 1[X(A) \ge X_n] \cdot \mathbb 1[S_{\mathrm{net}}(A, T_n, H \le H_n) \ge p_n] \cdot K_{U,<n}(A),
